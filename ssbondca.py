...
def parseatom(fileline): 
    res_id = fileline[22].strip() + ':' + fileline[23:26].strip() + ':' + fileline[27].strip() 
...
def ssbondreslists(fileline): 
    ssbondres1list.append(fileline[16].strip() + ':'+ abs(int(fileline[18:21].strip())) + ':' fileline[22].strip())
    ssbondres2list.append([16].strip() + ':'+ abs(int(fileline[32:35].strip())) + ':' fileline[22].strip())
...
for line in pdbsetoffiles: 
   ...
   for fileline in currentfile:
       ...
       if str(fileline[0:5]) == "SSBOND":
          
          ssbondreslists(fileline)
          print(str(fileline[7:9].strip()) + "," + str(fileline[11:13].strip()) + "," + str(fileline[15].strip()) + "," + str(fileline[17:20].strip()) + str(fileline[21].strip()) + "," + str(fileline[25:27].strip()) + "," + str(fileline[29].strip()) + "," + str(fileline[31:34].strip()) + "," + str(fileline[35].strip()) + '\n')
    for fileline in currentfile: 
